...
if __name__ == '__main__':
    ...
    label_class = {'AAUP': 'label_salary', 'albums': 'label', 'cities': 'label', 'forbes': 'label', 'movies': 'Label'}
    ...
    if DUMP:
        ...
        if method == 'INK':
            ...
            clf_4 = DecisionTreeClassifier()  # GridSearchCV(SVC(), {'C': [10 ** -3, 10 ** -2, 0.1, 1, 10, 10 ** 2, 10 ** 3]}, cv=3, n_jobs=4)
            clf_5 = DecisionTreeClassifier()  # GridSearchCV(LogisticRegression(),
            ...
            ink_total_NN.append(accuracy_score(df_test_extr[label_name].values, y_pred_1))
            ink_total_NN.append(f1_score(df_test_extr[label_name].values, y_pred_1, average='weighted'))
            ink_total_NN.append(precision_score(df_test_extr[label_name].values, y_pred_1, average='weighted'))
            ink_total_NN.append(recall_score(df_test_extr[label_name].values, y_pred_1, average='weighted'))

            ink_total_NB.append(accuracy_score(df_test_extr[label_name].values, y_pred_2))
            ink_total_NB.append(f1_score(df_test_extr[label_name].values, y_pred_2, average='weighted'))
            ink_total_NB.append(precision_score(df_test_extr[label_name].values, y_pred_2, average='weighted'))
            ink_total_NB.append(recall_score(df_test_extr[label_name].values, y_pred_2, average='weighted'))

            ink_total_tree.append(accuracy_score(df_test_extr[label_name].values, y_pred_3))
            ink_total_tree.append(f1_score(df_test_extr[label_name].values, y_pred_3, average='weighted'))
            ink_total_tree.append(precision_score(df_test_extr[label_name].values, y_pred_3, average='weighted'))
            ink_total_tree.append(recall_score(df_test_extr[label_name].values, y_pred_3, average='weighted'))

            ink_total_support.append(accuracy_score(df_test_extr[label_name].values, y_pred_4))
            ink_total_support.append(f1_score(df_test_extr[label_name].values, y_pred_4, average='weighted'))
            ink_total_support.append(precision_score(df_test_extr[label_name].values, y_pred_4, average='weighted'))
            ink_total_support.append(recall_score(df_test_extr[label_name].values, y_pred_4, average='weighted'))

            ink_total_log.append(accuracy_score(df_test_extr[label_name].values, y_pred_5))
            ink_total_log.append(f1_score(df_test_extr[label_name].values, y_pred_5, average='weighted'))
            ink_total_log.append(precision_score(df_test_extr[label_name].values, y_pred_5, average='weighted'))
            ink_total_log.append(recall_score(df_test_extr[label_name].values, y_pred_5, average='weighted'))

            ink_total_extra.append(accuracy_score(df_test_extr[label_name].values, y_pred_6))
            ink_total_extra.append(f1_score(df_test_extr[label_name].values, y_pred_6, average='weighted'))
            ink_total_extra.append(precision_score(df_test_extr[label_name].values, y_pred_6, average='weighted'))
            ink_total_extra.append(recall_score(df_test_extr[label_name].values, y_pred_6, average='weighted'))

            ink_total_random.append(accuracy_score(df_test_extr[label_name].values, y_pred_7))
            ink_total_random.append(f1_score(df_test_extr[label_name].values, y_pred_7, average='weighted'))
            ink_total_random.append(precision_score(df_test_extr[label_name].values, y_pred_7, average='weighted'))
            ink_total_random.append(recall_score(df_test_extr[label_name].values, y_pred_7, average='weighted'))
